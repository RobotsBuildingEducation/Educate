...
No release notes needed, description above will highlight work needed
...
<b>
The learning content is available through Patreon.
App subscriptions and Patreon contributions earned will go to the scholarship fund.
...
1. You want experience for your resume: [start here](https://github.com/RobotsBuildingEducation/Educate/blob/main/README.md#gaining-experience)
2. You want a mentor + life resources: [start here](https://github.com/RobotsBuildingEducation/Educate/blob/main/README.md#mentorship)
3. You're an investor that wants to learn more about me or my ideas: [start here](https://github.com/RobotsBuildingEducation/Educate#investor-relations)
4. You want to read through frequently asked questions: [start here](https://github.com/RobotsBuildingEducation/Educate#FAQ)
...
_TL;DR_ The goal of the first assignment is to get the project started using a React toolchain like. The key is explaining why one was selected over another. `create-react-app`, `next.js` or `hydrogen by Shopify`
...
- To apply to the scholarship: email robotsbuildingeducation@gmail.com with your story and vision. 
...
## FAQ
1. _What coding bootcamp or certification should I get to break into tech?_
